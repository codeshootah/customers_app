...
Customer.create(name: 'Lorem', phone: '+1 234 567 89 00', description: 'Tilde drinking vinegar selvage enamel pin, wolf tbh man bun vape.', black_list: false)

Customer.create(name: 'Schlitz', phone: '+1 234 567 89 00', description: 'Tilde drinking vinegar selvage enamel pin, wolf tbh man bun vape.', black_list: false)
